...
async def main(window):
    ...
    objects = [*floor, Block(0, HEIGHT - block_size * 2, block_size),
               ...
               ,Fire(800, HEIGHT - block_size*3 - 64, 16, 32)
               ...
               ,Block(block_size * 63, HEIGHT - block_size * 6, block_size)  
               ...
               ,Block(block_size * 80, HEIGHT - block_size * 2, block_size) 
               ,Block(block_size * 83, HEIGHT - block_size * 4, block_size)  
               ,Block(block_size * 85, HEIGHT - block_size * 5, block_size) 
               ,Fire(1900, HEIGHT - block_size - 64, 16, 32)
               ,Fire(600, HEIGHT - block_size*4 - 64, 16, 32)
               ,Fire(1000, HEIGHT - block_size*4 - 64, 16, 32)
               ,Fire(1150, HEIGHT - block_size*6 - 64, 16, 32)
               ,Fire(1200, HEIGHT - block_size - 64, 16, 32)
               ,Fire(1250, HEIGHT - block_size - 64, 16, 32)
               ,Fire(1550, HEIGHT - block_size*4 - 64, 16, 32)
